...
[[Adversarial example using FGSM](https://colab.research.google.com/github/tensorflow/docs/blob/master/site/en/tutorials/generative/adversarial_fgsm.ipynb)] 에서 FGSM으로 adversarial example을 생성하는 코드를 실습할 수 있다. 


<img src="https://ekspertos.github.io/assets/img/review/Adversarial/FGSM_colabImage.jpg" width="400">
